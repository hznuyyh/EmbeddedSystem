...
/*=====================================================================*/
void TouchScreen_ADS7843(void)
{
  u16 xdata, ydata;
  u32 xScreen, yScreen;
 // static int sDataX,sDataY;
  ...
  if((xScreen>1)&&(yScreen>1)&&(xScreen<240-1)&&(yScreen<320-1))
  {
      ...
      //if((GPIO_ADS7843_INT_VALID) && distence(touchPoint.x,xScreen) && distence(touchPoint.y,yScreen))
      //{  
      	
		touchPoint.x = xScreen;
      	touchPoint.y = yScreen;
	  	touchPoint.flag =1;
  	  //}
  }
